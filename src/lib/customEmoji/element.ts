...
export default class CustomEmojiElement extends HTMLElement {
  ...
  public renderer: CustomEmojiRendererElement | undefined;
  public player: RLottiePlayer | HTMLVideoElement | undefined;
  public paused: boolean;
  public syncedPlayer?: SyncedPlayer;
  public clean: boolean = false;
  public lastChildWas: Node | null = null;
  // public docId: DocId;
  public placeholder: HTMLImageElement | undefined;
  public middlewareHelper: MiddlewareHelper = new MiddlewareHelper();
  public static: boolean = false;
  public readyPromise: CancellablePromise<void> = new Promise<void>(() => {});

  constructor() {
    super();
    this.paused = true;
    this.elements = new Set<CustomEmojiElement>();
  ...
  public clear(replaceChildren = true) {
    ...
    /* this.disconnectedCallback =  */this.elements = new Set<CustomEmojiElement>();
      this.renderer =
      this.player =
      this.syncedPlayer =
      undefined;
